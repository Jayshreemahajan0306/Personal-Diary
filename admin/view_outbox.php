...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-12"><br>
	 ...
	 <i>View Outbox Of <?php echo $reg_fetch['Name'];?></i></h1><br>
	<form method="post">
	 <div>
...
?>
<tr>
<td><?php echo $diary_fetch['Receiver'];?></td>
