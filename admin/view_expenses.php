...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-12"><br>
	 ...
	 <i>View Expenses Of <?php echo $reg_fetch['Name'];?></i></h1><br>
	<form method="post">
	 <div>
...
<td><?php echo $diary_fetch['Grocery'];?></td>
<td><?php echo $diary_fetch['Vegeatables'];?></td>
<td><?php echo $diary_fetch['daily'];?></td>
<td><?php echo $diary_fetch['others'];?></td>
<td><?php echo $diary_fetch['total'];?></td>
</tr>
<?php
}	
  ?>
