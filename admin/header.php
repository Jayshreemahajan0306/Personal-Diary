  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="admin_welcome.php"><b>Home</b></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="admin_edit_profile.php"><b>Edit Profile</b></a>
      </li>
	   <li class="nav-item">
        <a class="nav-link" href="admin_contact.php"><b>Messages</b></a>
      </li>
	  <li class="nav-item">
